...
public interface INode<T extends Comparable<T>, V> {
	...
	* @return Tree.INode wrapper to the parent of the current node
	*/
	INode<T, V> getParent();    
    /**
	...
	* @return Tree.INode wrapper to the left child of the current node
	*/
	...
	* @return Tree.INode wrapper to the right child of the current node
	*/
